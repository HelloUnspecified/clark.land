---
name: 'Clark Sell'
tagline: 'AI is not the problem. Disconnection is.'
initials: 'CS'
whatx: 're:Human is a movement to rebuild the human connection in the age of intelligence. We help organizations and communities re-center people in a world increasingly run by machines — designing belonging, culture, and connection that scale.'
what: 're:Human is a movement to rebuild human connection in the age of intelligence. It’s where we rethink how technology and humanity coexist — and how we can design systems that make people feel seen, not replaced. It’s about re-centering the human layer in everything we build, culture, communities, and companies.'
...
about:
  ...
  biox: 'As an engineering leader, strategist, and community advocate, I’ve been architecting and building software for over 25 years. From working at Microsoft to working for myself, we’ve built systems both big and small. I even ran a giant tech conference called THAT Conference. Today, we’re at an amazing inflection point where AI is changing the landscape of how we fundamentally work. That’s not a bad thing, and it’s where I come into the picture. Tech doesn’t have to be scary, and we partner with companies like yours to understand the context, design a solution, and help you build a better tomorrow.'
  bio: 'Clark Sell is the founder of Unspecified, a human-centered systems company, and re:Human, a global movement to rebuild communities in the age of AI. For over 15 years, Clark led THAT Conference, a thriving community for technologists that grew to thousands of members across the U.S. There, he learned firsthand that community isn’t an accident — it’s something you can design. Today, through re:Human, Clark helps organizations, leaders, and teams design systems of culture and connection that keep humanity at the center of innovation. His work blends engineering precision, community design, and a deep belief that technology should bring us closer together, not further apart. When he’s not building or teaching, you’ll find him exploring the intersection of AI, creativity, and human behavior — or reminding anyone who will listen that human connection is the new infrastructure.'
...
socialLinks:
  ...
  - title: 'Email'
    href: 'mailto:clark@joinrehuman.com'
...
featuredCta:
  ...
  href: 'https://cal.joinrehuman.com/free-strategy-review'
...
ctaLinks:
  - title: '1:1 Coaching and Mentoring'
    href: 'https://cal.joinrehuman.com/coached-by-clark'
